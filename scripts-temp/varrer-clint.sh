#!/bin/bash
# Varre todas paginas do Clint chamando edge function repetidamente.
# Resilente a timeout/erro de rede: retry ate 3x na mesma pagina.
...
while true; do
  ...
  if [ "$PROXIMA" = "parse-error" ]; then
    ...
    echo "  Falha de rede. Tentativa $FALHAS_SEGUIDAS/3 na mesma pagina."
