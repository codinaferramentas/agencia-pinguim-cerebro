-- ============================================================
-- schema-026 — RPC matriz produto x frequencia (2026-06-18 noite)
-- ============================================================
-- Feedback Andre: dashboard ficou confuso (tabs cronologico vs calendario).
-- Solucao: matriz Produto x Frequencia (estilo Databricks Matrix View).
-- Esta RPC devolve TUDO que a matriz precisa em 1 chamada.
-- ============================================================
